...
Launch the container using Docker Desktop, then connect to psql. We will enable the extension and build a 1,000-row synthetic dataset representing historical loan applications.
