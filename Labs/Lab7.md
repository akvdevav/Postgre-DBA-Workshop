...
Point-in-Time Recovery (PITR): The ability to "replay" the Write Ahead Logs to a specific millisecond, allowing the engineer to restore the database to a state just before a data-loss event.38
