...
First, we will use your provided Podman command to spin up the PostgresML container and jump straight into an interactive psql session as the superuser.
